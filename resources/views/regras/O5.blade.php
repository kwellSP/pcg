...
<label for="quebrasO5" class="col-md-1">Quebrar</label>
<div class="col-md-2">
    <select class="form-control" id="quebrasO5" name="quebrasO5" value="{{old('quebrasO5')}}">
        <option value="nao">não</option>
        <option value="sim">sim</option>
    </select>   
</div>
<label for="numQuebrasO5" class="col-md-2">Num. Quebras</label>
<div class="col-md-2">
    <input type ="number"  min="2" class="form-control" id="numQuebrasO5" name="numQuebrasO5" value="{{old('numQuebrasO5')}}">
</div>
</div>
