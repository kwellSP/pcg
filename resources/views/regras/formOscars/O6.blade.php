...
<div class="hidden" id="tbOscar6" name="tbOscar">
    <h4 class="text-center">Oscar6 (Obs 3)</h4>
...
<label for="quebrasO6" class="col-md-1">Quebrar</label>
<div class="col-md-2">
    <select class="form-control" id="quebrasO6" name="quebrasO6" value="{{old('quebrasO6')}}">
        <option value="nao">não</option>
        <option value="sim">sim</option>
    </select>   
</div>
<label for="numQuebrasO6" class="col-md-2">Num. Quebras</label>
<div class="col-md-2">
    <input type ="number"  min="2" class="form-control" id="numQuebrasO6" name="numQuebrasO6" value="{{old('numQuebrasO6')}}">
</div>
</div>
...
<div class="quebrasO6">
  <h4 class="text-center">Quebras Oscar6 (Obs 3)</h4>
<div class="form-group form-group-sm">
...
<label for="regraO6" class="text-center col-md-12">Regra do Oscar 6</label>
<textarea class="form-control" rows ="3" disabled id ="regraO6" name ="regraO6" value="{{old('regraO6')}}"> </textarea>
</div>