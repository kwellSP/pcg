...
<div class="hidden" id="tbOscar4" name="tbOscar">
    <h4 class="text-center">Oscar4 (Obs 1)</h4>
...
<label for="quebrasO4" class="col-md-1">Quebrar</label>
<div class="col-md-2">
    <select class="form-control" id="quebrasO4" name="quebrasO4" value="{{old('quebrasO4')}}">
        <option value="nao">não</option>
        <option value="sim">sim</option>
    </select>   
</div>
<label for="numQuebrasO4" class="col-md-2">Num. Quebras</label>
<div class="col-md-2">
    <input type ="number"  min="2" class="form-control" id="numQuebrasO4" name="numQuebrasO4" value="{{old('numQuebrasO4')}}">
</div>
</div>
...
<div class="quebrasO4">
  <h4 class="text-center">Quebras Oscar4 (Obs 1)</h4>
<div class="form-group form-group-sm">
...
<label for="regraO4" class="text-center col-md-12">Regra do Oscar 4</label>
<textarea class="form-control" rows ="3" disabled id ="regraO4" name ="regraO4" value="{{old('regraO4')}}"> </textarea>
</div>