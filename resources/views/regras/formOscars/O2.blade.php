<div class="hidden" id="tbOscar2" name="tbOscar">
  ...
  <div class="form-group form-group-sm">
    ...
    <label for="quebrasO2" class="col-md-1">Quebrar</label>
    <div class="col-md-2">
        <select class="form-control" id="quebrasO2" name="quebrasO2" value="{{old('quebrasO2')}}">
            <option value="nao">não</option>
            <option value="sim">sim</option>
        </select>   
    </div>
    <label for="numQuebrasO2" class="col-md-2">Num. Quebras</label>
    <div class="col-md-2">
        <input type ="number"  min="2" class="form-control" id="numQuebrasO2" name="numQuebrasO2" value="{{old('numQuebrasO2')}}">
    </div>
  </div>
  ...
  <div class="quebrasO2">
      <h4 class="text-center">Quebras Oscar2 (Doc Cli)</h4>
  <div class="form-group form-group-sm">
  ...
  <label for="regraO2" class="text-center col-md-12">Regra do Oscar 2</label>
  <textarea class="form-control" rows ="3" disabled id ="regraO2" name ="regraO2" value="{{old('regraO2')}}"> </textarea>
</div>