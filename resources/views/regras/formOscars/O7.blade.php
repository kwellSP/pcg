...
<div class="hidden" id="tbOscar7" name="tbOscar">
    <h4 class="text-center">Oscar7 (Obs 4)</h4>
...
<label for="quebrasO7" class="col-md-1">Quebrar</label>
<div class="col-md-2">
    <select class="form-control" id="quebrasO7" name="quebrasO7" value="{{old('quebrasO7')}}">
        <option value="nao">não</option>
        <option value="sim">sim</option>
    </select>   
</div>
<label for="numQuebrasO7" class="col-md-2">Num. Quebras</label>
<div class="col-md-2">
    <input type ="number"  min="2" class="form-control" id="numQuebrasO7" name="numQuebrasO7" value="{{old('numQuebrasO7')}}">
</div>
</div>
...
<div class="quebrasO7">
  <h4 class="text-center">Quebras Oscar7 (Obs 4)</h4>
<div class="form-group form-group-sm">
...
<label for="regraO7" class="text-center col-md-12">Regra do Oscar 7</label>
<textarea class="form-control" rows ="3" disabled id ="regraO7" name ="regraO7" value="{{old('regraO7')}}"> </textarea>
</div>